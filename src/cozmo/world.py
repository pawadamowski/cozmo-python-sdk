...
class World(event.Dispatcher):
    ...
    async def define_custom_box(self, custom_object_type,
        ...
        Args:
            custom_object_type (:class:`cozmo.objects.CustomObjectTypes`): the object
                type you are binding this custom object to
            marker_front (:class:`cozmo.objects.CustomObjectMarkers`): the marker affixed
        ...
        custom_object_base = self.custom_object_factory(custom_object_type,
                                                        x_size_mm, y_size_mm, z_size_mm,
                                                        marker_width_mm, marker_height_mm,
